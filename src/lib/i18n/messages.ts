...
export type MessageKey =
  ...
  | "theme.layout"
  | "theme.density"
  | "theme.densityComfortable"
  | "theme.densityCompact"
  | "theme.radiusMode"
  | "theme.radiusDefault"
  | "theme.radiusRoundedMode"
  | "theme.radiusSharpMode"
  | "theme.designSystems"
...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    "theme.radiusMode": "Radius Mode",
    "theme.radiusDefault": "Default",
    "theme.radiusRoundedMode": "Rounded",
    "theme.radiusSharpMode": "Sharp",
  ...
  vi: {
    ...
    "theme.rounded": "Tròn",
    "theme.layout": "Bố cục",
    "theme.density": "Mật độ",
    "theme.densityComfortable": "Thoải mái",
    "theme.densityCompact": "Gọn",
    "theme.radiusMode": "Chế độ bo góc",
    "theme.radiusDefault": "Mặc định",
    "theme.radiusRoundedMode": "Bo tròn",
    "theme.radiusSharpMode": "Vuông",
